                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        ...
                        if ($user['role'] == "GL") {
                            ...
                            85%
                            <?php
                        } else if ($user['role'] == "SR") {
                            ?>
                            80%
                            <?php
                        } else if ($user['role'] == "JR") {
                            ?>
                            75%
                            <?php
                        } else if ($user['role'] == "NR") {
                            ?>
                            70%
                            <?php
                        }
                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs" id="tabs">
                            ...
                            <li>
                                <a href="#checklist" data-toggle="tab">Checklist</a>
                                ...
                                foreach ($checklist as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>: <input type="checkbox" disabled 
                                            <?php
                                            foreach ($agent_checklist as $agent_checklist_row) {
                                                if ($agent_checklist_row['agent_checklist_id'] == $row['agent_checklist_id']) {
                                                    ?>
                                                             checked
                                                             <?php
                                                         }
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <div class="box box-default">
                ...
                <div class="box-body" id="family-tree-container">
                    <?= $tree ?>
                    <div class="family-tree-legend-container">
                        <ul class="no-bullets">
                            <li><i class="fa fa-circle GL-bullet"></i> GL</li>
                            <li><i class="fa fa-circle TL-bullet"></i> TL</li>
                            <li><i class="fa fa-circle SR-bullet"></i> SR</li>
                            <li><i class="fa fa-circle JR-bullet"></i> JR</li>
                            <li><i class="fa fa-circle NR-bullet"></i> NR</li>
                        </ul>
                    </div>
                </div>
            </div>
